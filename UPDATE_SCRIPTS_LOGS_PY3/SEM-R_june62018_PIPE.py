...
negkws = [' 12s ', ' 16s ', ' 18s ', ' 23s ', ' 26s ', ' 28s ', ' alu ', 'mammalian genes involved in viral infection',
          ...
          ' rip tad ', ' rt pcr ', ' rtpcr ', ' scfv ', ' sine ',
          'anaphagefferens transposon insertion flanking sequence',
          'antibod', 'antisense iap', 'antivir', 'apolipoprotein', 'apoptosis inhibitor', 'archae',
          'artificial sequences',
          'atpase', 'bacteri', ' bark of madame vinous', ' beta lactamase', 'binding protein', 'caudovirales',
          'cellular',
          'chloroplast', 'choretroides', 'composition and methods', 'compositions and assays',
          ' elk retro ', ' entry protein', 'enveloping', 'express immune library', 'flanking',
          ' foxy transposable element',
          'gammaretroviral integration into nucleosomal target dna ', ' iap associated factor', ' iap like protein',
          ' iap nucleobase',
          'immunoglobulin', 'inclusion protein', 'inhibition of therapy', 'inhibitor of apoptosis',
          'integration 1 site',
          'integration junction', 'integration site', 'integron', 'interacting protein', 'interactive', 'interactor',
          'intergenic spacer', 'inverted repeat', 'involved in phenomena of', 'leishmania repetitive element',
          'macrophage',
          'markers for detecting genetic polymorphism', 'method for evaluating', 'microviridae', 'mitochondri',
          ' motor protein like ', ' mouse retroviral tagged', 'myovirid', 'neutralizing influenza virus', 'non ltr',
          'nonltr',
          'oncogene', 'oncoprotein', ' phage ', 'phagemid', 'phgmid', 'piggybac', ' poly a specific ribonuclease',
          'polyadenylation',
          'preintegration site', 'primer walking', ' probe set ', 'proviral insertion site', 'pseudogene',
          ' pspr rt mr ',
          ...
          'tandem repeats and reverse transcriptase primer binding site ', 'taphrinaceae', 'telomerase',
          'tobacco mosaic virus induced library',
          ...
          ' gut membrane polyprotein', 'harbinger', 'herves', 'histone polyprotein', 'hivep2', ' iap antagonist',
          'insertion site',
          'instability elements', 'interacting', 'junction', ' line retro ', ' line 1 ', ' line1 ', ' line like ',
          ' line type ',
          ' ltr centromeric satellite', ' ltr race ', 'microphage', ' non autonomous', 'nuclear envelope',
          ' outer envelope',
          'pegasus', 'plastid envelope', 'recombination protein', 'recombination site ', 'resistance',
          'retrotransposon line ', ' seed library', 'suppressor of ty',
          ' taco ', 'tigger', ' tip100 ', ' tn env ', ' trna gag ', ' trna leu ', 'ubiquitin polyprotein',
          ' viral associated', 'viralicidic', ' virus activating protease',
          ' virus transformed', 'vitelline envelope', ' line element', 'escherichia',
          'phosphate starvation inducible protein',
          ' t4 like major capsid protein', ' solo ltr ', 'spumarius', 'subtilisin like', 'retroposed',
          'deleted element',
          'pheidole harlequina', 'integrin associated protein', 'intestinal alkaline phosphatase',
          'vitalline coat protein',
          'islet amyloid polypeptide precursor',
          'satellite', 'integrin associated protein', ' ltr 1 interferon regulatory factor', ' pol rfamide',
          'plasmid replicase',
          " 3' flank ", " 5' flank ", ' pol cytoplasmic male sterility fragment', ' late cornified envelope',
          ' mlgapc ', ' g3pdh ', 'transposon etn ', 'retrotransposon line',
          'retroposed', 'philaenus spumarius', 'atelopus spumarius', 'isolate pol ', 'isolate ltr ',
          'human iap homolog', 'glucagon polyprotein', 'm gag 384',
          'polyprotein encoding gonadotropin releasing hormone', 'lysidyl aminotransferase',
          'cyclophilin a variant iap ', 'isolate 208 pol ', 'translocation breakpoint region',
          'intestinal alkaline phosphatase', 'islet amyloid polypeptide', 'allobates spumaponens', 'synthetic linker',
          'm pol ex 1169', 'sftpb jm ltr',
          'ribulosebisphosphate carboxylase form II polyprotein precursor', 'euglossa retroviridis',
          'diabrotica virgifera virgifera endogenous endoglucanase',
          'clone hhrii pol', 'endogenous vascular elastase', ' shell coat protein', ' ias virus ', ' egg envelope',
          ' t4 like ', ' t7 like ', ' t4like', ' t7like',
          'integration region', 'virus susceptibility', 'uncultured marine microorganism',
          'caenorhabditis elegans chromosome unknown clone', 'viral responsive protein',
          ' iap binding motif ', ' pcr product', ' anti viral ', ' env capsular antigen protein', ' ecotype ty ',
          ' zea mays cultivar ty', 'cornified envelope',
          'preintegration sequence', 'virion associated', 'endogenous antisense rna ', 'crossover point ',
          'intetration site ', 'chicken dna that hybridizes']

##################################################################################################
########## Negative keywords added 5/8/2018                                            ###########
##################################################################################################
negkwsnew = ['pequenovirus', 'thermococcus', 'streptococcus', 'bacillus', 'elongation factor', 'bindingprotein',
             'binding protein', '(-)inhibitory protein', '(-)inhibitory ptotein',
             'implicated in', 'restriction factor', 'LINE reverse transcriptase', 'seminal vesicle', 'Loa Loa 15kDa',
             'Mouse alpha-1 type-I collagen',
             'endogenous ligand', 'polymerase lambda', 'proteinase inhibitor', 'restriction factor', 'beta-tubulin',
             'beta tubulin', 'small outer capsid protein',
             'cell envelope', '5.8S rRNA', 'photosystem (psb)', 'cyanomyovirus (T4)', 'cyanomyovirus',
             'endogenous plasmid', 'proteasome', 'granzyme', 'angiogenesis',
             'pre-insertion region', 'transfer RNA', 'virus induced', 'virus-induced',
             'Chlamydia trachomatis integrase gene', 'rDNA insertion element',
...
neg_pol_finder = re.compile(
    '\s{1}pol\s{0,1}[a,b,d,e,h,i,k,1,2]\s{1}|\s{1}pol\s{0,1}ii\s{1}|\s{1}pol\s{0,1}iii\s{1}\s{1}pol\s{0,1}alpha\s{1}|\s{1}pol\s{0,1}beta\s{1}|\s{1}pol\s{0,1}delta\s{1}|\s{1}pol\s{0,1}epsilon\s{1}|\s{1}pol\s{0,1}eta\s{1}|\s{1}pol\s{0,1}ii\s{1}|\s{1}polymerase\s{0,1}[a,b,d,e,h,i,k,1,2]\s{1}|\s{1}polymerase\s{0,1}alpha\s{1}|\s{1}polymerase\s{0,1}beta\s{1}|\s{1}polymerase\s{0,1}delta\s{1}|\s{1}polymerase\s{0,1}epsilon\s{1}|\s{1}polymerase\s{0,1}eta\s{1}|\s{1}polymerase\s{0,1}ii\s{1}|\s{1}pol\s{0,1}mu\s{1}|\s{1}polymerase\s{0,1}mu\s{1}|\s{1}pol\s{0,1}kappa\s{1}|\s{1}polymerase\s{0,1}kappa\s{1}|\s{1}pol\s{0,1}[i,ii,iii][a,b,c,d,e,f,g,h,i,k]\s{1}|\s{1}polymerase\s{0,1}[i,ii,iii][a,b,c,d,e,f,g,h,i,k]\s{1}')
...
def run_pos_screen_allgb(date, fasta_filenames, istpa, neighaccs):
    ...
    outheadersfile = open(os.path.join(poskw_outdir, outheadersfn), 'w')
    logf = open(os.path.join(logdir, 'poskw_screen_log.txt'), 'w')
    poskw_outfns = []
    for fn in fasta_filenames:
        fn = fn.strip()

        if istpa:
            inf = open(os.path.join(tpadir, fn), "r")
        else:
            inf = open(os.path.join(gbdir, fn), "r")

        poskw_outfn = fn.replace('seq.' + date, 'seq.' + date + '.pscreen.fasta')
        poskw_outf = open(os.path.join(poskw_outdir, poskw_outfn), 'w')
...
def run_size_mirna_screen(date, pscreen_filenames, istpa):
    ...
    outheadersfile1 = open(os.path.join(sizemirna_outdir, outheadersfn1), 'w')
    outheadersfile2 = open(os.path.join(sizemirna_outdir, outheadersfn2), 'w')
    logf = open(os.path.join(logdir, 'sizemirna_screen_log.txt'), 'w')
    ...
    for fn in pscreen_filenames:
        print(fn)
        fn = fn.strip()
        inf = open(os.path.join(poskw_outdir, fn))
        ...
        size_mirna_outf1 = open(os.path.join(sizemirna_outdir, size_mirna_screen_fn1), 'w')
        size_mirna_screen_fn2 = fn.replace('.pscreen.fasta', '.sizemirnascreenFLAG.fasta')
        size_mirna_outf2 = open(os.path.join(sizemirna_outdir, size_mirna_screen_fn2), 'w')
...
def run_neg_screen(date, sizemirna_filenames, istpa, dupaccs):
    ...
    outheadersfile1 = open(os.path.join(negkw_outdir, outheadersfn1), 'w')
    outheadersfile2 = open(os.path.join(negkw_outdir, outheadersfn2), 'w')
    outheadersfile3 = open(os.path.join(negkw_outdir, outheadersfn3), 'w')
    outheadersfile4 = open(os.path.join(negkw_outdir, outheadersfn4), 'w')
    outheadersfile5 = open(os.path.join(negkw_outdir, outheadersfn5), 'w')

    logf = open(os.path.join(logdir, 'negkw_screen_log.txt'), 'w')

    for fn in sizemirna_filenames:
        fn = fn.strip()
        inf = open(os.path.join(sizemirna_outdir, fn))
        entries = inf.read().strip().split('>acc')[1:]
        ...
        nscreen_f1 = open(os.path.join(negkw_outdir, nscreen_fn1), 'w')

        nscreen_fn2 = fn.replace('.sizemirnascreenOK.fasta', '.nscreenOK_.fasta')
        nscreen_f2 = open(os.path.join(negkw_outdir, nscreen_fn2), 'w')

        nscreen_fn3 = fn.replace('.sizemirnascreenOK.fasta', '.nscreenFLAG_.fasta')
        nscreen_f3 = open(os.path.join(negkw_outdir, nscreen_fn3), 'w')

        nscreen_fn4 = fn.replace('.sizemirnascreenOK.fasta', '.nscreenAMB_.fasta')
        nscreen_f4 = open(os.path.join(negkw_outdir, nscreen_fn4), 'w')

        nscreen_fn5 = fn.replace('.sizemirnascreenOK.fasta', '.nscreenDUP_.fasta')
        nscreen_f5 = open(os.path.join(negkw_outdir, nscreen_fn5), 'w')
...
gbdir = os.path.join(wdir, 'GenBank_raw_data_' + date)
tpadir = os.path.join(wdir, 'TPA_raw_data_' + date)

if istpa:
    poskw_outdir = os.path.join(tpadir, 'poskw_out_' + date)
    sizemirna_outdir = os.path.join(tpadir, 'sizemirna_out_' + date)
    negkw_outdir = os.path.join(tpadir, 'negkw_out_' + date)
    scriptdir = os.path.join(tpadir, 'scripts')
    logdir = os.path.join(tpadir, 'log')
else:
    poskw_outdir = os.path.join(gbdir, 'poskw_out_' + date)
    sizemirna_outdir = os.path.join(gbdir, 'sizemirna_out_' + date)
    negkw_outdir = os.path.join(gbdir, 'negkw_out_' + date)
    scriptdir = os.path.join(gbdir, 'scripts')
    logdir = os.path.join(gbdir, 'log')

refseqdir = os.path.join(wdir, 'RefSeq_raw_data_' + date)

dupacc_filename = os.path.join(refseqdir, 'refseq_viral_originalaccs.txt')
dupacc_infile = open(dupacc_filename, "r")
#dupaccs = set(dupacc_infile.read().strip().split('\n'))
dupaccs = set(list(map(lambda x: x.strip(), dupacc_infile.readlines())))
dupacc_infile.close()

neighacc_filename = os.path.join(refseqdir, 'neighbor_accs.txt')
neighacc_infile = open(neighacc_filename, "r")
#neighaccs = set(neighacc_infile.read().strip().split('\n'))
neighaccs = set(list(map(lambda x: x.strip(), neighacc_infile.readlines())))
