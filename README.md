# **RVDB_PY3**
This is the repository of RVDB production scripts written by Python3 to replace the scripts in [RVDB old repository](https://github.com/ArifaKhanLab/RVDB) which were written by Python 2. Additionally, several improvements and refinements were implemented since the old release. 
